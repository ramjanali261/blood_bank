    ...
    <div class="container" style="margin-top:70px;">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <p>
                    Blood Bank &amp; <br>Bridha Memorial Trust, <br>
                    781015 ,Guwahati,<br>
                    Assam-781035.<br>
                    Kamprup Metro
                </p>
                <p><i class="fa fa-phone"></i>
                    <abbr title="Phone">P</abbr>: 7845814786
                </p>
                <p><i class="fa fa-envelope-o"></i>
                    <abbr title="Email">E</abbr>: <a href="#">bloodindonor@gmail.com</a>
                </p>
                <p><i class="fa fa-clock-o"></i>
                    <abbr title="Hours">H</abbr>: 24*7
                </p>
                <p><i class="fa fa-globe"></i>
                    <abbr title="Website">W</abbr>: <a href="index.php">www.bloodbank.co.org</a>
                </p>
